# -*- coding: utf-8 -*-
#
# pytest-datatest documentation build configuration file, created by
...
project = u'pytest-datatest'
copyright = u'2017, Shawn Brown'
author = u'Shawn Brown'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-datatest Documentation',
     [author], 1)
]
